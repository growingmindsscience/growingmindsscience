...
const TOOL_PAGES = [
  ...
  { rel: "tools/activity-library.html", kicker: "Free parent tool · Birth to 3" },
  { rel: "tools/reading-prompt-cards.html", kicker: "Free parent tool · Any book" },
  // Claims pages are generated by scripts/build-claims.mjs, which already
  // points them at this card; render only (wireMeta would create drift).
  { rel: "claims/index.html", slug: "claims-library", kicker: "Free · Evidence-graded", renderOnly: true },
];
for (const t of TOOL_PAGES) {
  const slug = t.slug || t.rel.split("/").pop().replace(/\.html$/, "");
